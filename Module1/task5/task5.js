/* Write a program that asks the user to enter a year and notifies the user whether the input year is a leap year.
 ...
 divisible by 400. Print the result on the HTML document. (3p)*/
 ...
 if((year % 4 === 0 && year% 100 !=0 ) || year % 400 === 0)
    document.body.innerHTML = `The year ${year} is a leap year`
else
    document.body.innerHTML = `The year ${year} is  not a leap year`